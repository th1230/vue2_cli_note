<template>
  <div class="footer">
    ...
    <button class="deleteButton" @click="deleteAllDoneItemFunction">
      清除已完成的任務
    </button>
  </div>
</template>
...
<script>
export default {
  props: ["todo", "deleteAllDoneItemFunction", "changeAllCheckedTypeFunction"],
  ...
  computed: {
    ...
    AllChecked: {
      ...
      set(value) {
        this.changeAllCheckedTypeFunction(value);
      },
    },
  },
};
